...
rpyc_file = find_file("rpyc.py", houdini_path)
...
if rpyc_file:
    print(f"\nrpyc.py found at: {rpyc_file}")
    print(f"Directory containing rpyc.py: {os.path.dirname(rpyc_file)}")
else:
    print("\nrpyc.py not found in the Houdini installation directory.")